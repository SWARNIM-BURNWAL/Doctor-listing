          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="#" className="hover:text-white">Search for Doctors</Link></li>
                <li><Link href="#" className="hover:text-white">Book Appointment</Link></li>
                <li><Link href="#" className="hover:text-white">Consult Online</Link></li>
                <li><Link href="#" className="hover:text-white">Health Articles</Link></li>
                <li><Link href="#" className="hover:text-white">Health Packages</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="#" className="hover:text-white">Join Medical Network</Link></li>
                <li><Link href="#" className="hover:text-white">Practice Management</Link></li>
                <li><Link href="#" className="hover:text-white">Success Stories</Link></li>
                <li><Link href="#" className="hover:text-white">Medical Resources</Link></li>
              </ul>
            </div>
